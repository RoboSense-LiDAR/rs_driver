...
Please first read [thread model and interface](../intro/02_thread_model.md), since this document imports some concept from it.
...
## 19.2.1 What cost CPU resources ?
...
### 19.3.1 MSOP/DIFOP Packet Queue
...
### 19.3.2 Point Cloud Queue

Point cloud is allocated by user. It is not discussed here.

### 19.3.3 Calculate sin()/cos() by table
...
### 19.3.4 Socket Receiving Buffer

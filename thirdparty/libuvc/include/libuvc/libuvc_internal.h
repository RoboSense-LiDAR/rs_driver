...
enum uvc_xu_ctrl_selector {
  ...
  UVC_XU_TRANSFER_MODE_CONTROL = 0x01,
  UVC_XU_PC_FPS_CONTROL = 0x02,
  UVC_XU_SYS_TIME_CONTROL = 0x04,
  UVC_XU_USB_MODE_CFG_CONTROL = 0xFE
};
...
struct uvc_stream_handle {
  ...
  uvc_frame_memory_get *user_m_get;
  uvc_frame_put *user_m_put;
  void *user_ptr;

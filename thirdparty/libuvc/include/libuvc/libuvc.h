...
typedef uint8_t *(uvc_frame_memory_get)(size_t size, void *user_ptr);
typedef void(uvc_frame_put)(void *user_ptr);
...
void uvc_exit2(uvc_context_t *ctx);
...
uvc_device_t *usb_device_creat_uvc_device(uvc_context_t *ctx, struct libusb_device *usb_dev);
void free_uvc_device(uvc_device_t *uvc_dev);
...
void uvc_close2(uvc_device_handle_t *devh);
